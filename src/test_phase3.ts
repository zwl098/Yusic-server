...
async function test() {
    try {
        ...
        console.log('Initial State:', stateRes.data);
        ...
        console.log('Playing State (Immediate):', stateRes.data);
        ...
        stateRes = await axios.get(`${BASE_URL}/rooms/${roomId}/state`);
        console.log('Playing State (After 2s):', stateRes.data);
        ...
        stateRes = await axios.get(`${BASE_URL}/rooms/${roomId}/state`);
        console.log('Paused State:', stateRes.data);
